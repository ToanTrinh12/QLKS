...
<script>
    ...
    document.getElementById("cart__statistical__home").addEventListener("click", function(event){
        window.location="http://localhost/qlkhachsan";
    });

    // click tiếp tục đặt hàng
    document.getElementById("cart__statistical__booking").addEventListener("click", function(event){
        window.location="http://localhost/qlkhachsan/listroom";
    });
    ...
    function editBooking(id){
        ...
        fetch("http://localhost/qlkhachsan/rooms/getAmountRoom/"+id)
        ...
        // get ra số lượng room đã sử dụng
        fetch("http://localhost/qlkhachsan/booking/GetAmountRoomId/"+id)
            .then(function(response) {
                return response.json();
            })
            .then(function(data){
    ...
    function deleteBooking(id){
        if (confirm("Bạn có muốn hủy đơn đặt phòng không") == true) {
            window.location="http://localhost/qlkhachsan/booking/deletebooking/"+id;
        }
    ...
    async function getCountBK() {
        let response = await fetch("http://localhost/qlkhachsan/Cart/getCountBooking");
